  ...
  <div class="overflow-hidden">
    <NCard >
      <NFlex justify="space-between">
        ...
        <NFlex align="center">
          <NInput v-model:value="queryData.name"  placeholder="请输入配置名称"
                  style="width: 180px" type="text" clearable >
            <template #prefix>
              <NIcon>
                <IosSearch />
              </NIcon>
      ...
      <div  class="flex-col h-full config-content" >
        <div v-for="(item,itemIndex) in deviceConfigList" :key="itemIndex" class="config-item" @click="openDetail(item)">
      ...
      <div class="pagination-box">
        ...
        <NPagination v-model:page="queryData.page" :page-size="queryData.page_size" :item-count="dataTotal"  @update:page="getData"   />
      </div>
<!--      <ConfigModal-->
<!--        :type="modalType"-->
