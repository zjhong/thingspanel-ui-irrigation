...
> = {
  ...
  apply_service: () => import('./apply/service/index.vue'),
  ...
  device_grouping_details: () => import('./device/grouping/details/index.vue'),
  ...
  management_setting: () => import('./management/setting/index.vue'),
