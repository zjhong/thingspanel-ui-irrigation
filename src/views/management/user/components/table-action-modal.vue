  ...
  <n-modal v-model:show="modalVisible" preset="card" :title="title" class="w-700px">
    <n-form ref="formRef" label-placement="left" :label-width="80" :model="formModel" :rules="rules">
      <n-grid :cols="24" :x-gap="18">
        <n-form-item-grid-item :span="12" :label="$t('page.user.form.name')" path="name">
          <n-input v-model:value="formModel.name" />
        </n-form-item-grid-item>
        <n-form-item-grid-item :span="12" :label="$t('page.user.form.email')" path="email">
          <n-input v-model:value="formModel.email" />
        </n-form-item-grid-item>
        <n-form-item-grid-item :span="12" :label="$t('page.user.form.phone')" path="phone_number">
        ...
        <template v-if="type === 'add'">
          <n-form-item-grid-item :span="12" :label="$t('page.user.form.password')" path="password">
            <n-input v-model:value="formModel.password" type="password" />
          </n-form-item-grid-item>
          <n-form-item-grid-item :span="12" :label="$t('page.user.form.confirmPwd')" path="confirmPwd">
