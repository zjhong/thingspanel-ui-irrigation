            ...
            >
              <NInput v-model:value="areaForm.locationTexe" placeholder="" />
                ...
                >
                  ...
                  经度:
                  <NInput disabled v-model:value="areaForm.location" />
                  纬度:
                  <NInput disabled v-model:value="areaForm.dimensionality" />
                </NFormItemGridItem>
...
import { spacesData, addArea } from "@/service/api/equipment-map";
  ...
  setup(props, context) {
    ...
    const methods = {
      ...
      add() {
        ...
        data.location =
          state.areaForm.location + "," + state.areaForm.dimensionality;
